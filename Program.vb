...
<body>
    <div class='container'>
        ...
        <div class='links'>
            <a href='/raw'>Alternative Version</a>
        </div>
    </div>
</body>
</html>"
...
<body>
    <div class='container'>
        ...
        ' Raw page with input form
        app.MapGet("/raw", Async Function(context As HttpContext)
                               Dim html = "<!DOCTYPE html>
<html>
<head>
    <title>WebGoat VB - User Input Demo</title>
...
<body>
    <div class='container'>
        <h1>WebGoat VB - User Input Demo</h1>
        <p>Enter your information below and submit to see it rendered:</p>
        <form action='/submit-raw' method='post'>
            <label for='username'>Username:</label>
            <input type='text' id='username' name='username' required>
        ...
        ' Handle raw form submission
        app.MapPost("/submit-raw", Async Function(context As HttpContext)
                                       Dim form = Await context.Request.ReadFormAsync()
